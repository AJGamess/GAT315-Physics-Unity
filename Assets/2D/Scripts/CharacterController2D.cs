...
public class CharacterController2D : MonoBehaviour
{
    ...
    [SerializeField] float sprintMultiplier = 1f;   // Sprint multiplier to movement speed
    ...
    public const int FACE_RIGHT = 1;                  // Constant for right facing direction
    public const int FACE_LEFT = -1;                  // Constant for left facing direction
    
    int facing = FACE_RIGHT;                             
    float currentSpeed = 0f;                       // Current horizontal speed after smoothing
    public int Facing => facing;                     // Public property to get the current facing direction
    public Rigidbody2D RB => rb;                  // Public property to get the Rigidbody2D component
    ...
    Health health;                              // Reference to the character's health component
    /// <summary>
    ...
    void FixedUpdate()
    {
        ...
        float targetSpeed = direction.x * speed * (sprinting ? sprintMultiplier : 1f);
    ...
    /// <summary>
    /// Handle sprint input. Called when sprint button is pressed.
    /// </summary>
    public void OnSprint()
    {
        sprinting = true;  // Set sprinting flag to true
        currentSpeed = direction.x * speed * sprintMultiplier;
    }

    public void OnSprintRelease()
    {
        sprinting = false;  // Set sprinting flag to false
        currentSpeed = direction.x * speed;
    }
    /// <summary>
