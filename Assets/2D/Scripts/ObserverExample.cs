...
public class ObserverExample : MonoBehaviour
{
	...
	public UnityEvent onFunctionStart;       // Will hold references to methods with no parameters
	public UnityEvent<int> onFunctionStop;     // Will hold references to methods that accept an int parameter
